...
function(){
    if(document.visibilityState === "visible"){
        document.title = "Portfolio | Shubhankar Poddar ";
        $("#favicon").attr("href","assests/images/favicon.png");
    }
    else {
        document.title = "See Ya !" ;
        $("#favicon").attr("href","assests/images/heart.gif");
    }
});
...
// <!-- typed js effect starts -->
    var typed = new Typed(".typing-text", {
        strings: ["MERN Stack","Competitive Programming","Technical Content Wrtiting","Open Source Enthusiastic"],
        loop: true,
        typeSpeed: 50,
		backSpeed: 25,
		backDelay: 500,
